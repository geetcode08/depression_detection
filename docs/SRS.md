...
├── README.md
├── .env.example
├── local setup docs  (optional, for local dev)
│
...
Use direct backend startup: install requirements, then run `uvicorn main:app --host 0.0.0.0 --port 8000`.
